...
def main():
    ...
    args = Namespace(
        ...
        # ===========================
        task="mimic_cxr_chen",
        config="config/train_mimic_cxr_chen_cvt2distilgpt2.yaml",
        ...
        exp_dir_trial="/data/lhy_data/Cvt2distillgpt2/results_mimic_cxr/trial_0",
        ...
        # warm_start_ckpt_path='/data/lhy_data/Cvt2distillgpt2/results_mimic_cxr/mimic_cxr_chen/train_mimic_cxr_chen_cvt2distilgpt2/trial_0/epoch=14-step=1920-val_chen_cider=0.535580.ckpt',
